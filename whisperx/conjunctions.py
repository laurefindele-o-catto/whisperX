...
conjunctions_by_language = {
    ...
    'bn': {'এবং', 'কিন্তু', 'অথবা', 'যেহেতু', 'যদি', 'ও', 'আর', 'নতুবা', 'নচেৎ', 'বরণ', 'তবুও', 'অথচ', 'বটে', 'বরং', 'সুতরাং', 'তবে', 'তাই', 'ফিরে', 'কারণ', 'কেননা', 'যাতে', 'যেন', 'যদ্যপি', 'তথাপি', 'যদিদ্যাৎ', 'হয়তো', 'নয়তো', 'নচেৎ', 'কি', 'বা', 'কিংবা', 'নচেৎ', 'কিবা', 'পক্ষান্তরে', 'বরঞ্চ', 'সেহেতু', 'তদুপরি', 'অন্যথায়', 'বৈকি', 'নইলে'}
}
